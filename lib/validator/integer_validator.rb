...
module Validator
  ...
  class IntegerValidator < BaseValidator
    ...
    #
    # @example
    #   Validator.integer.min(0).validate(5)   # passes
    #   Validator.integer.min(10).validate(5)  # fails
    ...
    #
    # @example
    #   Validator.integer.max(100).validate(50)  # passes
    #   Validator.integer.max(10).validate(50)   # fails
    ...
    #
    # @example
    #   Validator.integer.between(1, 10).validate(5)  # passes
    #   Validator.integer.between(1, 10).validate(15) # fails
    ...
    #
    # @example
    #   Validator.integer.greater_than(10).validate(15) # passes
    #   Validator.integer.greater_than(10).validate(10) # fails
    ...
    #
    # @example
    #   Validator.integer.less_than(100).validate(50) # passes
    #   Validator.integer.less_than(10).validate(10)  # fails
    ...
    #
    # @example
    #   Validator.integer.positive.validate(10) # passes
    #   Validator.integer.positive.validate(0)  # fails
    #   Validator.integer.positive.validate(-5) # fails
    ...
    #
    # @example
    #   Validator.integer.negative.validate(-5) # passes
    #   Validator.integer.negative.validate(0)  # fails
    #   Validator.integer.negative.validate(5)  # fails
    ...
    #
    # @example
    #   Validator.integer.non_negative.validate(0)  # passes
    #   Validator.integer.non_negative.validate(5)  # passes
    #   Validator.integer.non_negative.validate(-1) # fails
    ...
    #
    # @example
    #   Validator.integer.non_positive.validate(0)  # passes
    #   Validator.integer.non_positive.validate(-5) # passes
    #   Validator.integer.non_positive.validate(1)  # fails
    ...
    #
    # @example
    #   Validator.integer.multiple_of(5).validate(25) # passes
    #   Validator.integer.multiple_of(5).validate(23) # fails
    ...
    #
    # @example
    #   Validator.integer.even.validate(4) # passes
    #   Validator.integer.even.validate(5) # fails
    ...
    #
    # @example
    #   Validator.integer.odd.validate(5) # passes
    #   Validator.integer.odd.validate(4) # fails
    def odd(message: nil)
      add_validation(message: message) do |val|
        val.odd? || "must be odd"
      end
